                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-lg-7">
                                        <input type="text" class="form-control" name="urut" placeholder="Urut" value="<?= $customer->urut ?>">
                                        <small class="help-block"></small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control" name="count_siswa" placeholder="Jumlah Siswa" value="<?= $customer->count_siswa ?>">
                                        <small class="help-block"></small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="competitor" placeholder="Kompetitor" value="<?= $customer->competitor ?>">
                                        <small class="help-block"></small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <input type="text" class="form-control" name="nama_user" placeholder="Sumber Dana" value="<?= $customer->nama_user ?>">
                                        <small class="help-block"></small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <textfield type="text" class="form-control" name="notes" placeholder="Catatan" value="<?= $customer->notes ?>">
                                        <small class="help-block"></small>
                                    </div>
                                </div>
                            </div>
